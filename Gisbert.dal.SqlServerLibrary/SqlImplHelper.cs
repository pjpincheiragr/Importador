...
namespace Eximo.dal.SqlServerLibrary
{
    public class SqlImplHelper
    {
        ...
        public static string getConexionIquality()
        {
            ...
            {
                _connectionIQuality = ConfigurationManager.ConnectionStrings["ConexionIquality"].ConnectionString;
            }
        ...
        public static string getConexionIActivos()
        {
            ...
            {
                _connectionIActivos = ConfigurationManager.ConnectionStrings["ConexionIActivos"].ConnectionString;
            }
